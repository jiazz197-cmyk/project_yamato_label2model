...
@method_decorator(
    ...
    To perform most tasks with the Yamato API, you must specify the project ID, sometimes referred to as the `pk`.
    To retrieve a list of your Yamato projects, update the following command to match your own environment.
...
@method_decorator(
    ...
    decorator=extend_schema(
        ...
        description="""
    Create a project and set up the labeling interface in Yamato using the API.
