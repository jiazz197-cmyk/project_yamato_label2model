 ...
 * - `output_video.mp4` is the converted video file ready for use in Yamato.
 *
 * Using this FFmpeg command to re-encode your videos will help eliminate playback issues and ensure that Yamato detects the total video duration accurately, providing a smooth annotation experience.
 *
 ...
 * @meta_description Customize Yamato with the Video tag for basic video annotation tasks for machine learning and data science projects.
