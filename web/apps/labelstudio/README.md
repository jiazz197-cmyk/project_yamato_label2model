...
The Yamato App is the cornerstone of the frontend aspect of Yamato. This React-based application is where the magic of frontend development for Yamato occurs. In this app, developers have the freedom and capability to create new pages and determine how libraries are utilized within the Yamato environment. It's a purely frontend module, dedicated to crafting and refining the user interface and user experience aspects of Yamato.
...
- **`yarn ls:watch`: Build LSF continuously**
    - Automatically builds the Yamato on every change, providing a real-time development experience.
